...
class _ChatState extends State<Chat> {
  ...
  void createRecord(String text, String type) async {
    ...
    DocumentReference ref = await databaseReference.collection("chats").document(widget.orderId).collection("messages")
        .add({
      'type': type,
      'message': text,
                  ...
                  children: <Widget>[
                    Expanded(
                      child: StreamBuilder<QuerySnapshot>(
                        stream: _firestore
                            .collection('chats').document(widget.orderId).collection("messages")
